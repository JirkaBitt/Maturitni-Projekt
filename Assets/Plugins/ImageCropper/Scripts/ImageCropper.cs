...
#pragma warning restore 0649
	...
	public void Show( Texture image,string selectString, CropResult onCrop, Settings settings = null, ImageResizePolicy croppedImageResizePolicy = null )
	{
		if( image == null )
		{
		...
		selectText.GetComponent<Text>().text = selectString;
		cropCallback = onCrop;
	...
	public void Skip()
	{
		if( cropCallback != null )
		{
			...
			cropCallback( true, m_orientedImage.texture, result );
		}
